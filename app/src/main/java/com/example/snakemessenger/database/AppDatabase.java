...
@Database(entities = {Contact.class, Message.class, MessageExchangeLog.class, MediaMessageUri.class}, version = 1)
...
public abstract class AppDatabase extends RoomDatabase {
    ...
    public abstract MediaMessageUriDao getMediaMessageUriDao();
}
